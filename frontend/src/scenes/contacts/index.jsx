...
const Contacts = () => {
    ...
    const columns = [
        ...
        { field: "affiliation", headerName: "Agensi", headerAlign:"left", align: "left"},
        ...
        { field: "photo", headerName: "Gambar", flex: 1, renderCell: (params) => <Avatar src={params.row.photo} /> , sortable: false}, 
    ];
    ...
    return(
        <Box m="20px">
            ...
            sx={{
                ...
                >
                <DataGrid rows={data} columns={columns} components={{ Toolbar: GridToolbar }} getRowId={(row) => row.channelId} />
            </Box>
        </Box>
    )
}
